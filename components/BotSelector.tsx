  ...
  return (
    <>
      <button
        ...
        className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 px-3 py-2 rounded-md border border-terminal-border bg-terminal-surface
      ...
      >
        ...
        <span>{selectedBot ? "Change" : "Select Bot"}</span>
      </button>
      ...
      {showList && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-terminal-surface border border-terminal-border rounded-t-xl sm:rounded-xl p-4 sm:p-6 max-w-lg w-full sm:mx-4 mx-0 animate-slide-up shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-semibold text-sm text-terminal-text">Select Trading Bot</h3>
              <button
              ...
              {BOTS.map((botDef) => (
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span className={`text-[9px] px-1.5 py-0.5 rounded shrink-0 ml-2 ${
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 mb-2">
                    <span className="text-[9px] text-terminal-glow bg-terminal-glow/10 px-1.5 py-0.5 rounded">
                      {botDef.strategy}
                    </span>
                    <span className="text-[9px] text-terminal-muted bg-terminal-surface/50 px-1.5 py-0.5 rounded">
                      {botDef.symbol}
                    </span>
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    {botDef.features.map((feature, i) => (
                      <div key={i} className="flex items-center gap-1 text-[9px] text-terminal-muted">
